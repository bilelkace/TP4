...
BankAccount account = new SavingsAccount(201, 3.5 ,2.5);
SavingsAccount savingsAccount = (SavingsAccount) account;
System.out.println("Conversion explicite réussie : " + (savingsAccount != null));
BankAccount anotherAccount = new CheckingAccount(202, 1000.0 , 200.2);
...
SavingsAccount savingsAccount1 = new SavingsAccount(101, 5.0 , 2.5);
...
CheckingAccount checkingAccount1 = new CheckingAccount(102, 500.0 ,50.5);
